...
const TagOfArticle = ({ tag, tagsOfArticle,setTagsOfArticle,tagsOthers,setTagsOthers }: TagListItemProps) => {

    const handleDelete = () => {
        const newTagsOfArticle = tagsOfArticle.filter((t: TagItem) => t.id != tag.id)
